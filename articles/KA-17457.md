...
keywords: “KCS、AEM、常见、关键问题、Adobe Experience Manager、操作方法、分析”
...
- [进行线程转储和顶级输出](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17452.html#) 并执行 [线程分析](https://helpx.adobe.com/cn/experience-manager/kb/thread-dump-analysis.html).  检查导致高CPU使用率的线程是否是本机JVM垃圾回收线程。  如果使用最多CPU时间的线程是“VM线程”或任何垃圾收集线程，则可能存在内存问题。

---
title: “AEM日志中的SegmentNotFoundException和实例不起作用”
...
- 从此处下载oak-run jar文件 [https://repo1.maven.org/maven2/org/apache/jackrabbit/oak-run/](http://repo1.maven.org/maven2/org/apache/jackrabbit/oak-run/)

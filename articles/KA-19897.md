...
1. 以管理员用户或属于的本地用户身份登录AEM `administrators/user-administrators` 群组。
2. 在下选择菜单 [!UICONTROL 工具] > [!UICONTROL 安全性] > [!UICONTROL 用户]
3. 选择目标用户
4. 选择 [!UICONTROL 属性] 从 [!UICONTROL 操作] 工具栏
5. 选择 [!UICONTROL 更改密码] 按钮
6. 在对话框中填写以下内容，然后选择 [!UICONTROL 保存] 按钮
   - [!UICONTROL 新密码] :输入新密码
   - [!UICONTROL 重新键入密码] :输入相同的密码
   - [!UICONTROL 您的密码] :输入用户密码
7. 选择 [!UICONTROL 保存并关闭] 在标题部分中

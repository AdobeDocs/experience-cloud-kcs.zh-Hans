...
1. Dispatcher能够发送和接收来自定义的“RENDERS”之一的“200 OK”响应。
   ...
   <b>注意：</b> 如果否 [/timeout](https://experienceleague.adobe.com/docs/experience-manager-dispatcher/using/configuring/dispatcher-configuration.html?lang=zh-Hans) /renders上的设置，或者设置为0 ，那么它将永远等待与AEM实例的连接，即使该实例已关闭。

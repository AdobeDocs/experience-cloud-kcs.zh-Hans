---
title: “无法将内容从AEM 6.1迁移到6.5”
description: “了解如何解决在从v6.1迁移到v6.5内容期间引发栈栈跟踪的Adobe Experience Manager问题。”
solution: Experience Manager
product: Experience Manager
applies-to: "Experience Manager 6.5"
keywords: “KCS、Adobe Experience Manager 6.5、迁移内容，”
...
如果在将内容从Adobe Experience Manager v6.1迁移到v6.5的过程中发生栈栈跟踪，则建议先迁移到AEM v6.3，然后再迁移到v6.5。

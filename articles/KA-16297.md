...
确认AEM中的Campaign用户具有复制权限。  有关步骤，请参阅 [设置复制权限](https://experienceleague.adobe.com/docs/experience-manager-65/administering/security/security.html?lang=en#setting-replication-privileges)在管理指南中……

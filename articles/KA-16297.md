---
title: AEM模板提取自 [!DNL Campaign] 控制台
description: 描述
...
# AEM模板提取自 [!DNL Campaign] 控制台

## 描述


问题描述=将AEM模板同步到 [!DNL Campaign]，我们会收到以下错误：
...
需要在AEM服务器中向Campaign的AEM用户授予复制权限。  我们授予了 [!DNL Campaign]/content/campaign和/content/dam路径下的AEM用户，其中存在营销活动资产。

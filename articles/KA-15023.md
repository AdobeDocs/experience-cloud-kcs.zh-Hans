...
单击“Event and Conditions”（事件和条件）下的+按钮，为启动YouTube视频创建条件。 例如，您已添加条件“Element Exists”来查找特定div“player”以启动YouTube视频。

<b>步骤3：添加操作 — 配置变量</b>

单击操作下的+按钮以创建新的操作项。 这将作为设置Video Analytics变量的单点配置。 您使用了一些硬编码值。 但是，您可以使用数据元素来填充这些变量。
...
1. 从扩展下拉列表中选择“核心”。
2. 从操作类型下拉列表中选择“自定义代码”。
3. t-size：12.0pt”`>` 在“名称”文本框中添加操作名称。
4. 在“语言”下选择“Javascript”。
5. 选中“全局执行”。
6. 单击“打开编辑器”。
7. 在底部，添加以下代码并单击save。
...
2. 从操作类型下拉列表中选择“自定义代码”。
3. 在“名称”文本框中添加操作名称。
4. font-size：12.0pt”`>` 在“语言”下选择“Javascript”。
5. pan style=&quot;font-size：12.0pt&quot;`>` 选中“全局执行”。
6. style=&quot;font-size：12.0pt&quot;`>` 单击“打开编辑器”。
7. span style=&quot;font-size：12.0pt&quot;`>` 添加访客ID服务代码。
8. 在顶部，添加以下代码并单击save。

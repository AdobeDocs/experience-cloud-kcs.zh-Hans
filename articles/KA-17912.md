---
title: “了解缓存 | AEM”
description: “了解Dispatcher缓存如何发生以及如何在Adobe Experience Manager中配置它。”
solution: Experience Manager
product: Experience Manager
applies-to: "Experience Manager"
keywords: “KCS、缓存、Dispatcher缓存、AEM、Experience Manager”
...
在本文中，您将了解如何进行Dispatcher缓存，以及如何通过使用基线安装中的以下默认缓存目录来配置缓存 — 
...
我们希望已发布的站点尽可能贪婪，并缓存所有内容。

如果存在在缓存时破坏体验的元素，则可以添加规则以删除用于缓存该项目的选项。 如上面的示例所示，不应缓存并排除csrf令牌。 有关编写这些规则的更多详细信息，请参阅 [此处](https://experienceleague.adobe.com/docs/experience-manager-dispatcher/using/configuring/dispatcher-configuration.html?lang=en#configuring-the-dispatcher-cache-cache).

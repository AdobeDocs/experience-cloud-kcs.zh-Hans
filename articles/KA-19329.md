...
keywords: KCS、AEM、Adobe Experience Manager、formAlreadySubmitted、datatypeMessage、未从英语翻译、常见问题解答
...
这个问题是一个没有国际化的信息。 错误消息“Invalid date - Value must be of date datatype”即使应该使用德语（客户的浏览器语言）也使用英文。

检查德语clientlib /libs/fd/af/runtime/clientlibs/I18N/de/javascript/LogMessages.js时，我们看到消息是英语的，并且进一步添加了占位符{0}，这意味着消息的部分是动态的。

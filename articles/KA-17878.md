---
title: “AEMaCS无法访问资产UI和内容分发，出现\“放弃获取队列状态\”错误”
description: 描述
...
此问题受GRANITE-37870和SKYOPS-24148的影响。 临时的解决方法是刷新内容分发队列。 请按照以下步骤进行刷新。

1. 执行 *测试连接* in *内容分发代理* UI。(`http://IP:PORT/libs/granite/distribution/content/distribution-agent.html?agentName=publish)`
2. 在网站的UI中激活虚拟页面。

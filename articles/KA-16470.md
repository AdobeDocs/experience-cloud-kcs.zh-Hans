...
它面向Adobe顾问、Adobe合作伙伴和其他经验丰富的实施专家。

配置此集成需要完全了解本指南中涵盖的每个解决方案的实施流程。

Adobe客户可以联系 [Adobe Professional Services](https://business.adobe.com/customers/consulting-services/contact-us.html) 或 [Adobe合作伙伴](https://business.adobe.com/customers/partners/main.html) 以了解有关此集成的更多信息。

---
title: “请求标头字段的大小超过服务器限制”
description: 了解如何解决在AEM中打开页面时出现\“Bad Request\”错误。
solution: Experience Manager as a Cloud Service,Experience Manager
product: Experience Manager as a Cloud Service,Experience Manager
applies-to: "Experience Manager as a Cloud Service,Experience Manager"
keywords: “KCS、大小、请求标头、超过、服务器限制、AEM、Adobe Experience Manager、故障排除、AEMaaCS、Adobe Experience Manager as a Cloud Service”
...
Apache has a default `LimitRequestLine` of *8K*. 欲知更多信息，请查阅 [Apache的核心功能： LimitRequestLine指令](https://httpd.apache.org/docs/2.4/en/mod/core.html#limitrequestline) （位于Apache网站）。

可以通过增加以下项的值来克服此错误： `#LimitRequestFieldSize` 和 `#LimitRequestLine`.

<u>对于AMS/内部部署</u>：

可以在Apache配置文件中提高标头限制 —  `httpd.conf`.
